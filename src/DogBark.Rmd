...
This found `r length(tm$s)` peaks, and I don't see an easy way to merge adjascent peaks.
...
I wasn't happy with the results from timer, and I didn't like the output format.
